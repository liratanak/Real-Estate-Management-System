 ...
 */
class Houses extends \RealEstate\Entity\Houses implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setTypeuid($typeuid);
    }

    public function getTypeuid()
    {
        $this->__load();
        return parent::getTypeuid();
    }
    ...
    {
        $this->__load();
        return parent::setAddressuid($addressuid);
    }

    public function getAddressuid()
    {
        $this->__load();
        return parent::getAddressuid();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'uid', 'pid', 'hidden', 'disabled', 'deleted', 'createdtime', 'createduseruid', 'lastmodifiedtime', 'lastmodifieduseruid', 'validtimestart', 'validtimeend', 'isroomrent', 'cost', 'available', 'otherinfo', 'useruid', 'typeuid', 'sizeuid', 'addressuid');
    }
