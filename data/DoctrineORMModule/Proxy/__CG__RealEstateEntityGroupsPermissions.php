 ...
 */
class GroupsPermissions extends \RealEstate\Entity\GroupsPermissions implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setGroupuid($groupuid);
    }

    public function getGroupuid()
    {
        $this->__load();
        return parent::getGroupuid();
    }

    public function setPermissionsuid($permissionsuid)
    {
        $this->__load();
        return parent::setPermissionsuid($permissionsuid);
    }

    public function getPermissionsuid()
    {
        $this->__load();
        return parent::getPermissionsuid();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'uid', 'pid', 'hidden', 'disabled', 'deleted', 'createdtime', 'createduseruid', 'lastmodifiedtime', 'lastmodifieduseruid', 'validtimestart', 'validtimeend', 'groupuid', 'permissionsuid');
    }
