...
class Comment extends \RealEstate\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'pid', 'hidden', 'disabled', 'deleted', 'createdTime', 'lastModifiedTime', 'validTimeStart', 'validTimeEnd', 'content', 'createdUser', 'lastModifiedUser', 'user', 'house');
    }
