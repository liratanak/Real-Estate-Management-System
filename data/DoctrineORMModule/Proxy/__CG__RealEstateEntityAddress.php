...
class Address extends \RealEstate\Entity\Address implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'uid', 'pid', 'hidden', 'disabled', 'deleted', 'createdtime', 'createduseruid', 'lastmodifiedtime', 'lastmodifieduseruid', 'validtimestart', 'validtimeend', 'house', 'street', 'vilage', 'longitude', 'latitude', 'district', 'quarter', 'city');
    }
