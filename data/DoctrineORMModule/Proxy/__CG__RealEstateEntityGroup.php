 ...
 */
class Group extends \RealEstate\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'pid', 'hidden', 'disabled', 'deleted', 'createdTime', 'lastModifiedTime', 'validTimeStart', 'validTimeEnd', 'title', 'permission', 'createdUser', 'lastModifiedUser');
    }
